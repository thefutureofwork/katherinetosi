(function(){
  ...
  if(tag){rail.insertBefore(btn,tag)}else{rail.appendChild(btn)}
  var isHome=location.pathname.endsWith('index.html')||location.pathname.endsWith('/');
  var cp=isHome?'#credentials':'index.html#credentials';
  var ct=isHome?'#contact':'index.html#contact';
  var nav=document.createElement('nav');
  nav.className='mob-nav mono';
  nav.innerHTML='<a href="index.html">Home</a><a href="practice.html">Practice</a><a href="marks.html">Marks</a><a href="evidence.html">Student Work</a><a href="'+cp+'">Credentials</a><a href="'+ct+'">Contact</a>';
  var header=rail.closest('header')||rail.parentElement;
